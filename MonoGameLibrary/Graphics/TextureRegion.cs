...
public class TextureRegion
{
    ...
    /// <summary>
    /// Gets or Sets the source rectangle boundary of this texture region within the source 
    /// </summary>
    ...
    /// <summary>
    /// Creates a new texture using the specified source texture
    /// </summary>
    /// <param name="texture">The texture ti use as the source texture for this texture region</param>
    /// <param name="x">The x-coordinate position of the upper-left corner of this texture region relative to the upper-left corner of the course texture</param>
    /// <param name="y">The y-coordinate position of the upper-left corner of this texture region relative to the upper-left corner of the course texture</param>
